    ...
    <div class="v-search bg-white rounded shadow rounded my-1 d-print-none">
      ...
      <b-col class="py-1">
        <vue-good-table
          ...
          mode="remote"
          style-class="vgt-table table-horizontal-scroll report-amount"
          compact-mode
          line-numbers
          :style="cssProps"
          :sort-options="{
...
<style>
  ...
  .report-amount.table-horizontal-scroll thead tr:last-child th:nth-child(4) {
    left: var(--left-third);
    /* left: 310px; */
    z-index: 1;
  }
  ...
  .report-amount.table-horizontal-scroll .column-third {
    /* left: 310px; */
    left: var(--left-third);
  }
  /* tùy chỉnh left khi scroll*/
