...
<script>
export default {
  name: 'AppCustomerUpdate',
  data() {
    return {
      foods: [
        { name: 'Sữa bột Vinamilk Organic Gold 4' },
        { name: 'Nước Vfresh cam ép 100% - Hộp 1L' },
        { name: 'Sữa đặc Ngôi Sao Phương Nam xanh lá - 1284g' },
      ],
    }
  },
}
